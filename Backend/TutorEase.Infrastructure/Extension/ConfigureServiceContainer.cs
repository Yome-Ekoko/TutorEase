...
using TutorEase.Core.BackgroundServices;
using TutorEase.Core.Contract;
using TutorEase.Core.Contract.Repository;
using TutorEase.Core.Implementation;
using TutorEase.Core.Repository;
using TutorEase.Domain.Entities;
using TutorEase.Domain.Settings;
using TutorEase.Infrastructure.Configs;
...
using System.Net;
using System.Text;
using IClientFactory = TutorEase.Core.Contract.IClientFactory;
using TutorEase.Infrastructure.Interceptor;
using Pomelo.EntityFrameworkCore.MySql.Infrastructure;

namespace TutorEase.Infrastructure.Extension
{
        ...
        public static void AddSwaggerOpenAPI(this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "TutorEase WebAPI",
                        Version = "1",
                        Description = "API Details for TutorEase Admin",
                        Contact = new OpenApiContact()
                        {
                            Email = "info@theTutorEase.com",
                            Name = "The Coronation Portal",
                            Url = new Uri(" https://tutorease.com")
                        },
        ...
        public static void AddCustomControllers(this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.Configure<ApiBehaviorOptions>(apiBehaviorOptions =>
                apiBehaviorOptions.InvalidModelStateResponseFactory = actionContext =>
                {
                    ...
                    return new BadRequestObjectResult(new Domain.Common.Response<IEnumerable<string>>("TutorEase Validation Error", 400, errorList));
                });
        }
