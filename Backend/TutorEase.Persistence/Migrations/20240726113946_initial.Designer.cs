...
namespace TutorEase.Persistence.Migrations
{
    ...
    [Migration("20240726113946_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TutorEase.Domain.Entities.T_User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TutorEase.Domain.Entities.T_Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TutorEase.Domain.Entities.T_User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TutorEase.Domain.Entities.T_UserRole", b =>
                {
                    b.HasOne("TutorEase.Domain.Entities.T_Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
